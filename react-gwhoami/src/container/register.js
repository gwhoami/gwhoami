                        ...
                        <div class="flex ... ">
                            <div class="w-1/2 ... ">
                                <div class="row border border-slate-300 hover:border-red-800 ...">
                                    ...
                                    <InputDOB styleClass="flex flex-row mb-0" formKey="dob" ID="dob" formRef={regRef} uiRefresh={ui} label="DOB" placeholder="DOB" required="required" callback={dobCallback} />
                                </div>
                            </div>
                            &nbsp;&nbsp;&nbsp;
                            <div class="w-1/2 ... ">
                        ...
                        <div class="flex ... ">
                            <div class="w-1/2 ... ">
                                <div class="col border border-slate-300 hover:border-red-800 ...">
                                    <InputSelect styleClass="flex flex-row mb-0" formKey="country" formRef={regRef} uiRefresh={ui} label="" options={["United State", "India"]} placeholder="Select country" required="required" callback={countryCallback} />
                        ...
                        <div class="flex ... ">
                            ...
                            <div class="w-1/2 ... ">
                                <div class="row border border-slate-300 hover:border-red-800 ...">
                                    ...
                                    <InputText styleClass="flex flex-row mb-0" formKey="city" formRef={regRef} uiRefresh={ui} label="" placeholder="Country/City" required="required" />
                                </div>
                            </div>
                        </div>
